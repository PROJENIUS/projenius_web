    ...
    <div className="terms-container">
      ...
      <section className="terms-section">
        ...
        <ul>
          ...
          <li>If the project involves hardware components and ProJenius is purchasing them, we will only provide the original hardware bill</li>
      ...
      <section className="terms-section">
        <h2>7. Revisions & Edits</h2>
        <p>
          We offer up to 2 free revisions per project phase. Major changes beyond the original scope may require additional charges.
        </p>
      </section>
